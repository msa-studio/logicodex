...
- **Codegen safety net** in `src/codegen.rs`:
  - `LlvmCompiler::emit_v130_ast_in_v121()` emits `unreachable!()` panic with informative message if v1.30 AST nodes leak into v1.21 codegen.
...
- All 17 `validate_v130_pipeline.py` structural checks pass:
  - CompilerPipeline enum + FromStr ✅
  - Parser::with_pipeline() ✅
  - v1.21 trap arms (struct/enum/unsafe/extern) 4/4 ✅
  - v1.30 parse methods (struct/enum/unsafe/extern) 4/4 ✅
  - v1.30 dispatch arms 4/4 ✅
  - AST extensions ✅ | HIR If statement ✅ | TypeRegistry integration ✅
  - AddressOf fix ✅ | ExternBlock fix ✅
  - Codegen safety nets 4/4 ✅ | compile_v130() ✅ | CodegenBackend ✅
  - Semantic gate If ✅ | CLI --pipeline ✅ | Default v1.21 ✅
  - Documentation ✅
