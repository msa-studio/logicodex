...
## Version Gate Architecture (Edition Routing)

The repository now implements a **version-gated compiler pipeline** inspired by Rust Editions. This allows v1.30 language constructs to be developed without destabilizing the v1.21-alpha baseline:
