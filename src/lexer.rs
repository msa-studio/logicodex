...
impl TryFrom<&str> for TokenKind {
    ...
    fn try_from(identity: &str) -> Result<Self, Self::Error> {
        match identity {
            ...
            "KOTAK" => Ok(TokenKind::Kotak),
            "PINTU" => Ok(TokenKind::Pintu),
            "LAHIRKAN" => Ok(TokenKind::Lahirkan),
            "HANTAR" => Ok(TokenKind::Hantar),
            "TERIMA" => Ok(TokenKind::Terima),
            "TUNGGU" => Ok(TokenKind::Tunggu),
...
fn default_aliases() -> &'static [(&'static str, TokenKind)] {
    &[
        ...
        ("file_handle", TokenKind::FileHandle),
        ("KOTAK", TokenKind::Kotak),
        ("Kotak", TokenKind::Kotak),
        ("kotak", TokenKind::Kotak),
        ("PINTU", TokenKind::Pintu),
        ("Pintu", TokenKind::Pintu),
        ("pintu", TokenKind::Pintu),
        ("LAHIRKAN", TokenKind::Lahirkan),
        ("Lahirkan", TokenKind::Lahirkan),
        ("lahirkan", TokenKind::Lahirkan),
        ("HANTAR", TokenKind::Hantar),
        ("Hantar", TokenKind::Hantar),
        ("hantar", TokenKind::Hantar),
        ("TERIMA", TokenKind::Terima),
        ("Terima", TokenKind::Terima),
        ("terima", TokenKind::Terima),
        ("TUNGGU", TokenKind::Tunggu),
        ("Tunggu", TokenKind::Tunggu),
        ("tunggu", TokenKind::Tunggu),
        ("OPEN", TokenKind::Open),
        ("Open", TokenKind::Open),
