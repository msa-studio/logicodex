...
impl TryFrom<&str> for TokenKind {
    ...
    fn try_from(identity: &str) -> Result<Self, Self::Error> {
        match identity {
            ...
            "I8" => Ok(TokenKind::TypeI8),
            "I16" => Ok(TokenKind::TypeI16),
            "U8" => Ok(TokenKind::TypeU8),
            "U64" => Ok(TokenKind::TypeU64),
            ...
            "PORT" => Ok(TokenKind::Port),
            "POLICY" => Ok(TokenKind::Policy),
            "HANDLER" => Ok(TokenKind::Handler),
            "BLOCK" => Ok(TokenKind::Block),
            "DROP_OLDEST" => Ok(TokenKind::DropOldest),
...
fn default_aliases() -> &'static [(&'static str, TokenKind)] {
    &[
        ...
        ("GUNA", TokenKind::Use),
        ("use", TokenKind::Use),
        ("import", TokenKind::Use),
        ("IMPORT", TokenKind::Use),
        ("AWAM", TokenKind::Public),
        ...
        ("I8", TokenKind::TypeI8),
        ("i8", TokenKind::TypeI8),
        ("INT8", TokenKind::TypeI8),
        ("I16", TokenKind::TypeI16),
        ("i16", TokenKind::TypeI16),
        ("INT16", TokenKind::TypeI16),
        ("U8", TokenKind::TypeU8),
        ("u8", TokenKind::TypeU8),
        ("UINT8", TokenKind::TypeU8),
        ("U64", TokenKind::TypeU64),
        ("u64", TokenKind::TypeU64),
        ("UINT64", TokenKind::TypeU64),
        ...
        ("Block", TokenKind::Block),
        ("block", TokenKind::Block),
        ("DROP_OLDEST", TokenKind::DropOldest),
        ("DropOldest", TokenKind::DropOldest),
        ("drop_oldest", TokenKind::DropOldest),
        // Note: "Error" sebagai token keyword tak didaftarkan — guna string literal dalam manifest
        ("OPEN", TokenKind::Open),
        ("Open", TokenKind::Open),
        ("open", TokenKind::Open),
        ...
        ("bit_xor", TokenKind::BitXor),
        ("XOR_BIT", TokenKind::BitXor),
        ("^", TokenKind::BitXor),
        ("BIT_XOR", TokenKind::BitXor),
        ("<<", TokenKind::ShiftL),
...
impl fmt::Display for TokenKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TokenKind::HwZone => write!(f, "HW_ZONE"),
            ...
            TokenKind::CInterop => write!(f, "C_INTEROP"),
            ...
            TokenKind::DropOldest => write!(f, "DROP_OLDEST"),
            ...
            TokenKind::BitAnd => write!(f, "BIT_AND"),
            TokenKind::BitOr => write!(f, "BIT_OR"),
            TokenKind::BitXor => write!(f, "BIT_XOR"),
            TokenKind::ShiftL => write!(f, "SHIFT_L"),
            TokenKind::ShiftR => write!(f, "SHIFT_R"),
