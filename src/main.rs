...
=========================================================
Architect & Creator: Mohamad Supardi Abdul (mymsastudio@gmail.com)
logicodex 1.11-alpha
Security Profile: EBNF Formal Grammar Integration"#;
